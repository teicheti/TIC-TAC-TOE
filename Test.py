...
anfang1 = Label (fenster, text = "Dies ist ein normales TIC-TAC-TOE Spiel.")
anfang2 = Label (fenster, text = "Dabei geht es darum als erster 3 Kästchen in einer Reihe zu haben.")
anfang3 = Label (fenster, text = "Es gibt drei Möglichkeiten:")
anfang1.pack ()
anfang2.pack ()
anfang3.pack ()

beginnen = Button (fenster, text = "Fortfahren", command = anfang1.destroy ())
beginnen.pack ()
