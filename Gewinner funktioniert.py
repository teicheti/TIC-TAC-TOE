...
class SPIELFELD:
    def __init__ (self):
        ...
        fenster.title ("Tic-Tac-Toe")   #Name + Größe Fenster
        ...
        waagereechte = self.spielfeld.create_line (0,100,300,100, width = 3)
    ...
    def makieren_o (self, x1, y1, x2, y2):
        O = self.spielfeld.create_oval (x1, y1, x2, y2, width = 2)   # (linker Punkt, oberer P, rechter P, unterer P)
        # Kreis zeichnen
    ...
    def befehl(self):   #Befehle
        ...
        if (self != Beenden and self != Neustart and SPIELFELD.sieger == 0):
            ...
            if (SPIELFELD.gewinner [0] == SPIELFELD.gewinner [1] == SPIELFELD.gewinner [2] == "x" or
                ...
                SPIELFELD.sieger = 1
                gewinner = Label (fenster, text = "X HAT GEWONNEN", fg = "red")
                gewinner.place (x = 92, y = 313)
                ...
                SPIELFELD.sieger = 1
                gewinner = Label (fenster, text = "O HAT GEWONNEN", fg = "red")
                gewinner.place (x = 92, y = 313)
                #Gewinnmöglichkeiten + Sieger zum beenden der Runde + Label
...
SPIELFELD = SPIELFELD ()    #Spielfeld aufreufen    #Fenster definieren
